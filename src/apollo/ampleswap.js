...
const APIURL = "https://api.thegraph.com/subgraphs/name/shrinivasmani/pknew2";
      ...
      <div className="board-col col2 pancakeswap ample">
        <div className="board-block hot-pairs">
          <div className="col-title">
            <span className="icon icon-home-pancakeswap">
              <img src="images/ample.png" alt="" />
            </span>{" "}
            AMPLESWAP <strong>NEW PAIRS</strong>
            ...
            {data.map(function (object, i) {
              return (
                <div className="pair-item">
                  <a
                    className="left"
                    href={`/bsc/ample/pair-explorer/${object.id}`}
                  >
                    <div className="pair-logo">#{i + 1}</div>
                  ...
                  <div className="right">
                    <NumberFormat
                      value={object.reserveUSD}
                      displayType={"text"}
                      thousandSeparator={true}
                      prefix={"$"}
                      decimalScale={0}
                    />{" "}
                    <small className="total_home_lp">Total liquidity</small>
                  </div>
                </div>
              );
            })}
