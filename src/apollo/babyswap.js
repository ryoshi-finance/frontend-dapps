...
const APIURL = 'https://api.thegraph.com/subgraphs/name/babyswapgraph/exchange3'
...
function Bigswap(obj) {
  ...
  useEffect(async () => {
   ...
   if(obj.view){
       viewPools = <> <a href='/pools-list/babyswap' className='see-more'> See More  </a> </>
   }
        ...
        <>
                    <div className="board-col col2 pancakeswap ample">
                        <div className="board-block hot-pairs">
                            <div className="col-title"><span className="icon icon-home-pancakeswap"><img src="/images/baby.png" alt="" /></span> BABYSWAP <strong>NEW PAIRS</strong><img className="line" src="/images/line.svg" />{viewPools}</div>
                            <div className="col-content">

                            {data.map(function(object, i){
                                return <div className="pair-item">
                                    <a className="left" href={`/bsc/babyswap/pair-explorer/${object.id}`}>
