...
function Suniexchange(obj) {
  ...
  useEffect(async () => {
   ...
   if(obj.view){
       viewPools = <> <a href='/pools-list/suni' className='see-more'> See More  </a> </>
   }
        ...
        <>
                    <div className="board-col col2 sushiswap">
                        <div className="board-block hot-pairs">
                            <div className="col-title"><span className="icon icon-home-uniswap"><img src="images/suniexchange.png" alt="" /></span> SUNI <strong>NEW PAIRS</strong><img className="line" src="images/line.svg" />{viewPools}</div>
                            <div className="col-content">

                            {data.map(function(object, i){
                                return <div className="pair-item">
                                    <a className="left" href={`/ether/suni/pair-explorer/${object.id}`}>
