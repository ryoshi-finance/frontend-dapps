...
function Sushiswap(obj) {
  ...
  useEffect(async () => {
   ...
   if(obj.view){
       viewPools = <> <a href='/pools-list/sushi' className='see-more'> See More  </a> </>
   }
        ...
        <>
                    <div className="board-col col2 sushiswap">
                        <div className="board-block hot-pairs">
                            <div className="col-title"><span className="icon icon-home-uniswap"><img src="images/sushiswap.png" alt="" /></span> SUSHISWAP <strong>NEW PAIRS</strong>{viewPools}</div>
                            <div className="col-content">

                            {data.map(function(object, i){
                                return <div className="pair-item">
                                    <a className="left" href={`/ether/sushi/pair-explorer/${object.id}`}>
