...
const APIURL = 'https://api.thegraph.com/subgraphs/name/sushiswap/bsc-exchange'
        ...
        <>
                    <div className="board-col col2 pancakeswap ample">
                        <div className="board-block hot-pairs">
                            <div className="col-title"><span className="icon icon-home-pancakeswap"><img src="/images/sushiswap.png" alt="" /></span> SUSHISWAP <strong>NEW PAIRS</strong><img className="line" src="/images/line.svg" /></div>
